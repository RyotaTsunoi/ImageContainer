...
export class ManageStorageIdentity {
  ...
  /**
   * ManageStorageIdentity factory.
   * @function
   * @param none
   * @return {Promise<ManageStorageIdentity>} ManageStorageIdentity
   */
...
export class ManageDatabaseIdentity {
  ...
  //if initialize this class, use factory method. storeage or database.
  /**
   * ManageDatabaseIdentity factory.
   * @function
   * @param none
   * @return {Promise<ManageDatabaseIdentity>} ManageDatabaseIdentity
   */
