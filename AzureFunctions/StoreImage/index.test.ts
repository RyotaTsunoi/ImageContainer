...
describe('Check base64 string or dataUri decode are right', () => {
  beforeEach(() => {
    process.env = Object.assign(process.env, {
      ...
      KEY_VAULT_NAME: localSettings.Values.KEY_VAULT_NAME,
      TARGET_STORAGE_ACCOUNT_NAME: localSettings.Values.TARGET_STORAGE_ACCOUNT_NAME,
      TARGET_STORAGE_ACCOUNT_KEY: localSettings.Values.TARGET_STORAGE_ACCOUNT_KEY,
      TARGET_DATABASE_CONNECTION_TYPE: localSettings.Values.TARGET_DATABASE_CONNECTION_TYPE,
      TARGET_DATABASE_CONNECTION_HOST: localSettings.Values.TARGET_DATABASE_CONNECTION_HOST,
      TARGET_DATABASE_CONNECTION_PORT: localSettings.Values.TARGET_DATABASE_CONNECTION_PORT,
      TARGET_DATABASE_CONNECTION_USERNAME: localSettings.Values.TARGET_DATABASE_CONNECTION_USERNAME,
      TARGET_DATABASE_CONNECTION_PASSWORD: localSettings.Values.TARGET_DATABASE_CONNECTION_PASSWORD,
    });
  });
